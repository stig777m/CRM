...
namespace Intra_App_Prj.Tests.Models
{
    public class UserTests
    {
        ...
        public void UserProperties_ValidData_ShouldNotThrowValidationException()
        {
            ...
            Xunit.Assert.Equal(123, user.Eid);
            Xunit.Assert.Equal("John Doe", user.Emp_Name);
            Xunit.Assert.Equal(DateTime.Now.Date, user.DOJ.Date);
            Xunit.Assert.Equal(DateTime.Now.AddYears(-30).Date, user.DOB.Date);
            Xunit.Assert.Equal("john.doe@company.com", user.PMail);
            Xunit.Assert.Equal("john.doe@work.com", user.WMail);
        ...
        public void UserProperties_InvalidData_ShouldThrowValidationException()
        {
            ...
            // Act & Assert
            // Use Xunit Xunit.Assert.Throws to verify that setting invalid values throws a ValidationException
            Xunit.Assert.Throws<ValidationException>(() => ValidateModel(invalidUser));
        }
        ...
        public void UserProperties_ValidWhatsApp_ShouldNotThrowValidationException()
        {
            ...
            // This should not throw any validation exception
            Xunit.Assert.NotNull(user);
            Xunit.Assert.Equal("1234567890", user.WhatsApp);
        }
        ...
        public void UserProperties_InvalidWhatsApp_ShouldThrowValidationException()
        {
            ...
            // Act & Assert
            // Use Xunit Xunit.Assert.Throws to verify that setting an invalid WhatsApp format throws a ValidationException
            Xunit.Assert.Throws<ValidationException>(() => ValidateModel(invalidUser));
        }
        ...
        public void UserProperties_ValidLinkedIn_ShouldNotThrowValidationException()
        {
            ...
            // This should not throw any validation exception
            Xunit.Assert.NotNull(user);
            Xunit.Assert.Equal("https://www.linkedin.com/in/johndoe", user.LinkedIn);
        }
        ...
        public void UserProperties_InvalidLinkedIn_ShouldThrowValidationException()
        {
            ...
            // Act & Assert
            // Use Xunit Xunit.Assert.Throws to verify that setting an invalid LinkedIn format throws a ValidationException
            Xunit.Assert.Throws<ValidationException>(() => ValidateModel(invalidUser));
        }
        ...
        public void UserProperties_ValidNickName_ShouldNotThrowValidationException()
        {
            ...
            // This should not throw any validation exception
            Xunit.Assert.NotNull(user);
            Xunit.Assert.Equal("JD", user.Nick_Name);
        }
        ...
        public void UserProperties_InvalidNickName_ShouldThrowValidationException()
        {
            ...
            // Act & Assert
            // Use Xunit Xunit.Assert.Throws to verify that setting an invalid NickName format throws a ValidationException
            Xunit.Assert.Throws<ValidationException>(() => ValidateModel(invalidUser));
        }
        ...
        public void UserProperties_ValidImage_ShouldNotThrowValidationException()
        {
            ...
            // This should not throw any validation exception
            Xunit.Assert.NotNull(user);
            Xunit.Assert.Equal("image.jpg", user.Image);
        }
        ...
        public void UserProperties_InvalidImage_ShouldThrowValidationException()
        {
            ...
            // Act & Assert
            // Use Xunit Xunit.Assert.Throws to verify that setting an invalid Image format throws a ValidationException
            Xunit.Assert.Throws<ValidationException>(() => ValidateModel(invalidUser));
        }
    }
}
