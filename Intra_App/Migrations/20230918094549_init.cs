        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PMail = table.Column<string>(type: "TEXT", nullable: false),
                    WMail = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_AspNetUsers_E_Id",
                        column: x => x.E_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    Image = table.Column<string>(type: "TEXT", nullable: true),
                    P_Date = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    E_Uid = table.Column<string>(type: "TEXT", nullable: false),
                    Eid = table.Column<string>(type: "TEXT", nullable: false),
                    Response = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventDetails", x => x.Uid);
                    table.ForeignKey(
                        name: "FK_EventDetails_AspNetUsers_E_Uid",
                        column: x => x.E_Uid,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventDetails_Events_Eid",
                        column: x => x.Eid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventDetails_E_Uid",
                table: "EventDetails",
                column: "E_Uid");

            migrationBuilder.CreateIndex(
                name: "IX_EventDetails_Eid",
                table: "EventDetails",
                column: "Eid");
